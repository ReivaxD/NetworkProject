...
implements Message {
	...
	public static class DV {
		...
		public final ArrayList<IPAddress> path;

		public DV(IPAddress dst, int metric, ArrayList<IPAddress> path) {
			this.dst= dst;
			this.metric= metric;
			this.path= path;
		}
	...
	public void addDV(IPAddress dst, int metric, ArrayList<IPAddress> path) {
		dvs.add(new DV(dst, metric, path));
	}
